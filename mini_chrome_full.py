...
- popup blocker and a simple adblocker via request interceptor
...
# ---------- persistent storage ----------
DATA_FILE = os.path.join(os.getcwd(), "mini_chrome_data.json")
...
# Register interceptor - will be called after QApplication is created
...
class MiniChrome(QMainWindow):
    def __init__(self):
        super().__init__()
        register_interceptor()  # Set up the interceptor
